...
#import "DVersionComparator.h"

@implementation DVersionComparator

typedef NS_ENUM(NSInteger, DCharacterType) {
    kNumberType,
    kStringType,
    kSeparatorType,
};
...
{
    static DVersionComparator *defaultComparator = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        defaultComparator = [[DVersionComparator alloc] init];
    });
    return defaultComparator;
}

- (DCharacterType)typeOfCharacter:(NSString *)character
{
...
- (NSArray *)splitVersionString:(NSString *)version
{
    ...
    NSMutableString *s;
    NSUInteger i, n;
    DCharacterType oldType, newType;
